...
draw(iterate([[100,400], [400,400]], steps=4, height=-1), colour=colours[19])
draw(iterate([[100,400], [400,400]], steps=3, height=-1), colour=colours[18])
draw(iterate([[100,400], [400,400]], steps=2, height=-1), colour=colours[15])
draw(iterate([[100,400], [400,400]], steps=1, height=-1), colour=colours[7])
canvas.create_line(100,400,400,400, fill=colours[7])
