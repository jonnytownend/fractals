...
def draw(points, colour="black", wire=0):
	points2 = []
...
draw(iterate(shape(x, y, 5, size), steps=6, height=-1), colour=colours[7])
draw(iterate(shape(x, y, 5, size), steps=6, height=-0.5), colour=colours[6])
draw(iterate(shape(x, y, 5, size), steps=6, height=0.5), colour=colours[5])


draw(iterate(shape(x, y, 5, size), steps=6, height=1.1), colour="white")
draw(iterate(shape(x, y, 5, size), steps=5, height=-1), colour=colours[17], wire=1)

#draw(iterate(shape(x, y, 5, size), steps=6, height=1), colour=colours[17], wire=1)
#draw(iterate(shape(x, y, 5, size), steps=6, height=1.1), colour=colours[15], wire=1)
